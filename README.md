...
![npm version](https://img.shields.io/npm/v/glow-card-react.svg)
![npm downloads](https://img.shields.io/npm/dm/glow-card-react.svg)
![bundle size](https://img.shields.io/bundlephobia/minzip/glow-card-react?label=gzip)
